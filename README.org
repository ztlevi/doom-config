...
# utils
brew install fd sqlite hub watchman gpg2 coreutils ctags gnu-tar mplayer clang-format
# language
...
sudo pacman --needed --noconfirm -S sqlite ripgrep clang-format fd
#+END_SRC
...
**** Ubuntu
#+BEGIN_SRC shell
sudo apt install mplayer clang-format
#+END_SRC

**** npm
#+BEGIN_SRC shell
npm install -g cspell prettier import-js trash
#+END_SRC

**** pip
#+BEGIN_SRC shell
pip3 install pylint gnureadline black importmagic epc grip cpplint
#+END_SRC
